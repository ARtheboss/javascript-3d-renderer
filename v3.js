...
Camera.prototype.worldAxisRotated = function(){
    ...
    total_rotation = constructRotationQuaternion(new Vector(1, 0, 0), this.rot.x).multiply(total_rotation);
    total_rotation = constructRotationQuaternion(new Vector(0, 1, 0), this.rot.y).multiply(total_rotation);
    total_rotation = constructRotationQuaternion(new Vector(0, 0, 1), this.rot.z).multiply(total_rotation);
